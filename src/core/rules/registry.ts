...
export const RULES: readonly Rule[] = [
  ...
  rule("R011", "supporting-dirs", "Supporting dirs and referenced files stay in-skill", "structure", "info", "check"),
  ...
  rule("R020", "script-security", "Skill text and scripts free of dangerous patterns", "heuristic", "warning", "check", true),
