...
import { BUILTIN_PACKAGES, DEFAULT_PACKAGE, getPackage } from "./packages.js";
import { resolveEffectiveRules } from "./resolve.js";
import { RULES, resolveRuleId, type RuleSeverity, type RuleTier } from "./registry.js";
...
export function validateRulesConfig(value: unknown, path: string): string | null {
