...
import { confirm, isCancel, select, multiselect } from "@clack/prompts";
import { applyRemove, listRemoveCandidates, planRemove, resolveSkillName, type SkillMatch } from "../../../core/skill-remove.js";
