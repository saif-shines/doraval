...
function renderCatalogPage(): string {
  return [
    ...
    "---",
    "",
    "Each check has a code (`R012`) and a slug (`description-length`). Findings link here via `docUrl`.",
    "",
    "This table is generated from the rule registry. Edit the registry, not the rows.",
    "",
    renderCatalog(),
    "",
  ].join("\n");
