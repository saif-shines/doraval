---
title: validate
description: Validate resources so coding agent orchestrators achieve first-attempt success. Core tool in context engineering.
sidebar:
  order: 1
---

The primary command for orchestrators. Auto-detect skills, plugins, hooks, MCP, memory, and more. Point it at local code or a GitHub URL and catch problems *before* you hand the resource to new engineers or publish it to the community.
