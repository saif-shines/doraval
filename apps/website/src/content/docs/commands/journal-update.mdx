...
This is the recommended command to run at the start of a session, before `dora drift` / `dora judge`, or any time you want fresh principles without publishing new ones.
...
dora journal update && dora drift ./my-skill/
