---
title: Installation
description: Install the dora CLI, then add the four skills.
sidebar:
  label: Installation
  order: 2
---
...
That add installs `ask-dora`, `review-with-dora`, `grilling-for-routine`, and `writing-for-routine`. Details: [Skills](/get-started/skills/).
...
[Quick Start](/get-started/quickstart/) · [Skills](/get-started/skills/) · [Run a pocket agent](/get-started/pocket-agents/)
