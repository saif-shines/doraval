...
| `writing-for-routine` | Write `prompt.md` and, when frozen, the Fixed step Skill. Names the run handoff when the destination cannot tell. |
...
The whole loop: [Run a pocket agent](/get-started/pocket-agents/). What it is: [Pocket agent](/concepts/pocket-agent/).
