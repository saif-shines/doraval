...
`dora harness` is the front desk for an internal teammate. Hermes is the runtime. Dora does not install Hermes. Log in with Hermes. Dora does not run that login.
...
- Laptop close is host sleep, not `dora harness pause`.
