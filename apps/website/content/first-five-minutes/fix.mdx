...
When the scan (or review) lists auto-fixable issues, apply them with `dora fix`. Diffs always come first; nothing is written until you approve (unless you pass `--yes`).
...
**Next:** [Scaffold](/first-five-minutes/new/) with `dora new`, or re-run [Review](/first-five-minutes/review/) after fixes.
